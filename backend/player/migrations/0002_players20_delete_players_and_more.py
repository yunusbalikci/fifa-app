# Generated by Django 4.1 on 2023-12-16 11:55
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Players20',
            fields=[
                ('sofifa_id', models.IntegerField(primary_key=True, serialize=False, verbose_name='Sofifa ID')),
                ...
                ('international_reputation', models.IntegerField(verbose_name='International Reputation')),
                ...
                ('attacking_heading_accuracy', models.IntegerField(verbose_name='Attacking Heading Accuracy')),
                ('attacking_short_passing', models.IntegerField(verbose_name='Attacking Short Passing')),
                ...
                ('mentality_interceptions', models.IntegerField(verbose_name='Mentality Interceptions')),
                ...
                ('defending_standing_tackle', models.IntegerField(verbose_name='Defending Standing Tackle')),
                ('defending_sliding_tackle', models.IntegerField(verbose_name='Defending Sliding Tackle')),
                ...
                ('goalkeeping_positioning', models.IntegerField(verbose_name='Goalkeeping Positioning')),
        ...
        migrations.AlterField(
            model_name='teamsandleagues',
            name='league_name',
            field=models.CharField(max_length=255, verbose_name='League Name'),
        ),
        migrations.AlterField(
            model_name='teamsandleagues',
            name='url',
